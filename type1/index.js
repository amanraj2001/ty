// console.log("fnfn")
var arr = [{ "id": 1, "firstname": "john", "lastname": "doe", "address": "221b baker street", "salary": 20000 }, { "id": 2, "firstname": "sherlock", "lastname": "jamison", "address": "221b baker street", "salary": 40000 }, { "id": 3, "firstname": "watson", "lastname": "joe", "address": "221b baker street", "salary": 25000 }, { "id": 4, "firstname": "jake", "lastname": "tim", "address": "221b baker street", "salary": 30000 }, { "id": 5, "firstname": "jim", "lastname": "york", "address": "221b baker street", "salary": 10000 }];
// console.log(arr)
...
function add() {
    var x1 = parseInt(document.getElementById('one').value);
    var x2 = document.getElementById('two').value;
    var x3 = document.getElementById('three').value;
    var x4 = document.getElementById('four').value;
